...
function load_more() {
		...
		$.getJSON(url,function(result){ //alert(result);
	        ...
	        $.each(result, function(i, field){
	            ...
	            $("#listview").append("<li class='swipeout'><div class='swipeout-content item-content'><div class='post_entry'><div class='post_thumb'><img src='"+img_value+"' width='200' alt='' title='' /></div><div class='post_details'><div class='post_category'><a href='article-details.html?"+ article_id + "'>"+ article_title + "</a></div><span style='font-size:14px; font-weight:bold;'>By Fresh Box Office on <i class='fa fa-calendar'></i> "+post_date+"</span></div></div></div></li>");
				}
	        });
    	});	
		}
